...
interface RemoteTvSeriesDataSource {
    ...
    suspend fun getTvSeriesVideos(id: Int): List<TvSeriesVideoDto>
    suspend fun getTvSeriesSeasonDetails(seriesId: Int, seasonNumber: Int): SeasonDto
    suspend fun getTvSeriesImages(id: Int): List<TvSeriesImageDto>
    ...
    suspend fun getEpisodeImages(seriesId: Int, seasonNumber: Int, episodeNumber: Int): List<TvSeriesImageDto>
